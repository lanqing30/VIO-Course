...
//    std::cout << Qwb.coeffs().transpose() <<"\n"<<Qwb.toRotationMatrix() << std::endl;
    ...
    save_Pose_FOR_CH8("imu_pose_CH8.txt",imudata);
    save_Pose_FOR_CH8("imu_pose_noise_CH8.txt",imudata_noise);
    save_Pose_asTUM("imu_pose_CH8_TUM.txt",imudata);
    save_Pose_asTUM("imu_pose_noise_CH8_TUM.txt",imudata_noise);
    ...
    save_timestemp_CH8("cam_time.txt", camdata);
