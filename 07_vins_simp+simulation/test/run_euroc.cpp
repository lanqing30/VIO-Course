...
void PubImuData()
{
	string sImu_data_file = sConfig_path + "imu_pose_noise_CH8.txt";
...
void PubImageData()
{
	string sImage_file = sConfig_path + "cam_time.txt";
	...
	while (std::getline(fsImage, sImage_line) && !sImage_line.empty())
	{
		...
		//	return;
		//}
		string sim_img = sConfig_path +"/keyframe/"+"all_points_"+to_string(i)+".txt";
		i++;
		pSystem->PubImageData(dStampNSec, sim_img,i);
